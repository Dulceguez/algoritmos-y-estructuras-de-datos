...
public class GraphTest {
	...
	public void testConnectAndDisconnect() {
		...
		assertTrue(vert2.equals(adyacentes.get(0).getTarget()) || vert3.equals(adyacentes.get(0).getTarget()));
		assertTrue(vert2.equals(adyacentes.get(1).getTarget()) || vert3.equals(adyacentes.get(1).getTarget()));
