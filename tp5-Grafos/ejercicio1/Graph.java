...
public interface Graph<T> {
	...
	/**
	 * Elimina el vértice del Grafo. En caso que el vértice esté relacionado con
	 * otros, estas relaciones también se eliminan.
	 * 
	...
	/**
	 * Conecta el vértice origen con el vértice destino. Verifica que ambos vértices
	...
	/**
	 * Conecta el vertice origen con el destino con peso. Verifica que ambos
	 * vertices existan, caso contrario no realiza ninguna conexion
	 * 
	 * @param origen
	 * @param destino
	 * @param peso
	...
	/**
	 * Desconecta el vértice origen con el destino. Verifica que ambos vértices
	 * existan, caso contrario no realiza ninguna desconexión En caso de existir la
	 * conexión destino-->origen, esta permanecerá sin cambios.
	 * 
	 * @param origen
	 * @param destino
	 */
	...
	/**
	 * Retorna el peso entre dos vértices. En caso de no existir la arista retorna
	 * 0.
	 * 
	 * @param origen
	 * @param destino
